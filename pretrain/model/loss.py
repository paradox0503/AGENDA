...
class ScaledL2Trans(Module):
    ...
    def forward(self,func_aa, database, query1,query2, db_embedding, query_embedding1,query_embedding2):
        ...
        # embedding_l2 = (ED_2(db_embedding, query_embedding1)-ED_2(db_embedding, query_embedding2))/((self.__scale_factor_embedding*func_aa)*(self.__scale_factor_embedding*func_aa))
