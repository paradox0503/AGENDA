...
| FreqSpectra                         |                                                                             is a synthetic time-series dataset consisting of fixed-length sequences (256). Each sequence is generated in the frequency domain by selecting a small number of dominant frequency components and then transformed into the temporal domain via inverse discrete Fourier transform (IDFT).                                                                             |
