...
DATASET_CONFIGS = [
    DatasetConfig("Astro00", "data/astro-dataset.bin", 256, size_train=conf_size_train, size_val=conf_size_val, size_db=conf_size_db, index_name=0),
    ...
    DatasetConfig("origin", "data/origin-dataset.bin", 256, size_train=conf_size_train, size_val=conf_size_val, size_db=conf_size_db, index_name=4),
    ...
    DatasetConfig("seismic", "data/seismic-dataset.bin", 256, size_train=conf_size_train, size_val=conf_size_val, size_db=conf_size_db, index_name=6),
]# DATASET_CONFIGS
embed_CONFIGS = [
